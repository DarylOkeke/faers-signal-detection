#!/usr/bin/env python3
"""
FAERS Signal Detection Summary (DuckDB)
...
from src.stats import add_stats
...
def main():
    parser = argparse.ArgumentParser(description="Compute FAERS signal detection summary statistics (DuckDB)")
